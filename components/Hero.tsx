...
export default function Hero(){
    return (
        <div className="bg-hero 2xl:h-[712px] xl:h-[600px] lg:h-[550px] md:h-[500px] md:py-20" id="hero">
            <div className="container mx-auto px-10">
                ...
                <div className="text-center xl:mt-20 lg:mt-10 md:mt-6">
                    ...
                    <p className="text-white text-opacity-60 text-lg xl:w-4/12 2xl:w-3/12 lg:w-6/12 mx-auto mt-6 leading-relaxed">
